...
<html>
  ...
  <div id="container">    
    ...
    <nav class="navbar navbar-default" role="navigation">
     ...
     <table class="table table-hover">
      ...
      <tr>
        <?php if(is_array($pcinfo)): foreach($pcinfo as $key=>$p): ?><td >捡到</td>
        <td><?php echo ($p["type"]); ?></td>
        <td><?php echo ($p["thing_name"]); ?></td>
 ...
 if($p['if_give_back']==0){ ?>
      ...
      <?php
        ...
        <td><button type="lose" infoid="1" class="btn btn-sm btn-default" id="confirm"><span class="glyphicon glyphicon-ok"></span> <a href="<?php echo U('Home/PickInfo/confirm',array('pick_id'=>$p['pick_id']));?>">
          <?php
 if($p['if_give_back']==0){ ?>
      等待确认
      <?php
      ...
      <?php
        ...
        <td ><button type="lose" infoid="2" class="btn btn-sm btn-danger" ><span class="glyphicon glyphicon-remove"></span><a href="<?php echo U('Home/PickInfo/delete',array('pick_id'=>$p['pick_id']));?>">删除</a></button></td>
