...
<tbody>
	<?php if(is_array($arr_thing)): foreach($arr_thing as $key=>$t): ?><div class="message line" align="left">
		<p>类型：捡到&nbsp&nbsp&nbsp物品：<?php echo ($t["thing_name"]); ?><p/>
		<p>发布时间：<?php echo ($t["update_time"]); ?></p>
		<div id="comment">
		<p>评论:</p>
		<?php if(is_array($comment)): foreach($comment as $key=>$c): ?><p><?php echo ($c["comment"]); ?></p>
		<p align="right">------<?php echo ($c["name"]); ?> <?php echo ($c["datetime"]); ?></p><?php endforeach; endif; ?>
		</div>
