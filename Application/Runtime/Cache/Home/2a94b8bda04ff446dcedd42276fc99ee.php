...
<html>
  <head>
    ...
    <!-- Bootstrap -->
    <link href="/lost_and_found/Public/css/bootstrap.css" rel="stylesheet" media="screen">
    <link href="/lost_and_found/Public/css/application.css" rel="stylesheet" media="screen">
    <link href="/lost_and_found/Public/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
  ...
  <body>
    ...
    <img src="/lost_and_found/Public/img/herald.png" id="heraldLogoTop">
 ...
 <!-- picks Modal -->
  ...
  <div class="modal fade" id="loses" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <img id="pin" src="/lost_and_found/Public/img/pin.png"/>
    ...
    <div id="con-border">
      <div id="secondHead">
        <img src="/lost_and_found/Public/img/herald.png" id="heraldLogo">
    ...
    <script src="/lost_and_found/Public/js/jquery.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="/lost_and_found/Public/js/bootstrap.js"></script>
    <script src="/lost_and_found/Public/js/bootstrap-datetimepicker.min.js"></script>
    <script src="/lost_and_found/Public/js/bootstrap-datetimepicker.fr.js"></script>
    <script src="/lost_and_found/Public/js/animate.js"></script>
    <script src="/lost_and_found/Public/js/login.js"></script>
    <script src="/lost_and_found/Public/js/function.js"></script>
    <script src="/lost_and_found/Public/js/formhandle.js"></script>
  </body>
  </body>
</html>